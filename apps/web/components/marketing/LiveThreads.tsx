 ...
 * 4 visible thread rows. We rotate every 6s to give a "live, watching"
 ...
 * uses requestAnimationFrame; here we use a setInterval since the cadence
        ...
        {threads.map((t, i) => (
          ...
          >
            <div className="mb-1 flex items-center justify-between gap-2">
              <b className="truncate text-[12.5px] font-medium text-ink">{t.sender}</b>
              <span
