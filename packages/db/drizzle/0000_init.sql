CREATE TYPE "public"."ai_task_kind" AS ENUM('reply_suggest', 'summarize', 'sentiment', 'translate', 'escalate_check', 'memory_extract');--> statement-breakpoint
CREATE TYPE "public"."channel" AS ENUM('line', 'messenger', 'instagram');--> statement-breakpoint
CREATE TYPE "public"."conversation_status" AS ENUM('open', 'pending', 'resolved', 'closed');--> statement-breakpoint
CREATE TYPE "public"."message_direction" AS ENUM('inbound', 'outbound');--> statement-breakpoint
CREATE TYPE "public"."org_role" AS ENUM('owner', 'admin', 'agent');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "customer_memory" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
ALTER TABLE "ai_logs" ADD CONSTRAINT "ai_logs_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ai_logs" ADD CONSTRAINT "ai_logs_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_assignee_id_users_id_fk" FOREIGN KEY ("assignee_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_memory" ADD CONSTRAINT "customer_memory_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_memory" ADD CONSTRAINT "customer_memory_customer_id_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_memory" ADD CONSTRAINT "customer_memory_source_conversation_id_conversations_id_fk" FOREIGN KEY ("source_conversation_id") REFERENCES "public"."conversations"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "org_invites" ADD CONSTRAINT "org_invites_invited_by_users_id_fk" FOREIGN KEY ("invited_by") REFERENCES "auth"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "ai_logs_org_created_idx" ON "ai_logs" USING btree ("org_id","created_at");--> statement-breakpoint
CREATE INDEX "conversations_org_status_idx" ON "conversations" USING btree ("org_id","status","last_message_at");--> statement-breakpoint
CREATE INDEX "conversations_customer_idx" ON "conversations" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX "customer_memory_customer_idx" ON "customer_memory" USING btree ("customer_id");--> statement-breakpoint
...
CREATE POLICY "org_members_select_self_or_org" ON "org_members" AS PERMISSIVE FOR SELECT TO "authenticated" USING ("org_members"."user_id" = (select auth.uid()) or exists (select 1 from public.org_members m2 where m2.org_id = "org_members"."org_id" and m2.user_id = (select auth.uid())));--> statement-breakpoint
...
CREATE POLICY "organizations_select_member" ON "organizations" AS PERMISSIVE FOR SELECT TO "authenticated" USING (exists (select 1 from public.org_members m where m.org_id = "organizations"."id" and m.user_id = (select auth.uid())));--> statement-breakpoint
...
CREATE POLICY "organizations_insert_self" ON "organizations" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (true);--> statement-breakpoint
CREATE POLICY "user_profiles_select_self" ON "user_profiles" AS PERMISSIVE FOR SELECT TO "authenticated" USING ("user_profiles"."id" = (select auth.uid()));--> statement-breakpoint
